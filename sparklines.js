...
var BaseSparkline = function () {
    this.init = function (id, data, mixins) {
        ...
        this.last_point_color = undefined;
    ...
    this.draw = function () {
        ...
        with (Processing(sl.canvas)) {
            ...
            draw = function () {
                ...
                if (sl.last_point_color && scaled.length > 0) {
                    fill(sl.last_point_color);
                    stroke(sl.last_point_color);
                    var point = scaled[scaled.length - 1];
                    ellipse(point.x - 1, point.y, 3, 3);
                }
